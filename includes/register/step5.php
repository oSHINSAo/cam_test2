<?php
	...
	$model	= $models->getInfoModelPublic($_SESSION['iduser']);
?>
<style>
...
<div class="row-fluid text-center" style="color:#db2376;margin-top:30px;">
	<div class="col-md-12 col-lg-12" style="padding-bottom:25px;">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-3 col-md-3">
							<input type="text" class="form-control model-register" placeholder="Firstname" value="<?= $model['firstname']; ?>" readonly>
						</div>
						<div class="col-lg-3 col-md-3">
							<input type="text" class="form-control model-register" placeholder="Middlename" value="<?= $model['middlename']; ?>" readonly>
						</div>
						<div class="col-lg-3 col-md-3">
							<input type="text" class="form-control model-register" placeholder="Lastname" value="<?= $model['lastname']; ?>" readonly>
						</div>
						<div class="col-lg-3 col-md-3">
							<input type="text" class="form-control model-register" placeholder="Birthdate" value="<?= $model['birthdate']; ?>" readonly>
						</div>
					</div>

					<div class="row" style="margin-top:15px;">
						<div class="col-lg-6 col-md-6">
							<input type="text" class="form-control model-register" placeholder="Address" value="<?= $model['address']; ?>" readonly>
						</div>
						<div class="col-lg-6 col-md-6">
							<input type="text" class="form-control model-register" placeholder="Town/City" value="<?= $model['town-city']; ?>" readonly>
						</div>
					</div>

					<div class="row" style="margin: 15px -15px 0px -15px;">
						<div class="col-md-4 col-lg-4">
							<input type="text" class="form-control model-register" placeholder="ZipCode" value="<?= $model['countryName']; ?>" readonly>
						</div>
						<div class="col-md-4 col-lg-4">
							<input type="text" class="form-control model-register" placeholder="Town/City" value="<?= $model['zipcode']; ?>" readonly>
						</div>
						<div class="col-md-4 col-lg-4">
							<input type="text" class="form-control model-register" placeholder="Country" value="<?= $model['gender']; ?>" readonly>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row-fluid text-center">
			<button type="button" name="action" value="finish" class="btn btn-pink edit" data-step="6">Submit Application</button>
		</div>
