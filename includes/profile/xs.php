<style>
	...
	.textDownPicture-md{width: 188px;text-align: center;font-weight: bold;color:#fff;background-color: #db2379;border-radius: 0px 0px 10px 10px;position: relative;top:20px;left: 126px;}
...
<div class="container">
	<div class="row-fluid visible-md visible-md" style="height:300px;">
		<div id="owl-md">
			<div class="item"><img src="//placehold.it/220x240?text=1"></div>
	...
	<div class="row-fluid" style="margin-top:-80px;color:#45a4c4;position:relative;z-index:2;">
		...
		<div class="col-md-4">
			<div class="textDownPicture-md visible-md">
	...
	<div class="row-fluid" style="margin-top:80px;color:#949494;">
		<div class="col-md-3" style="border:1px solid #db2379">
		...
		<div class="col-md-9" style="border:1px solid #db2379;">
			 <!-- Nav tabs -->
			<ul class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active"><a href="#shopItemsMD" aria-controls="shopItems" role="tab" data-toggle="tab">Shop Items <strong>(13)</strong></a></li>
				<li role="presentation"><a href="#photosMD" aria-controls="photos" role="tab" data-toggle="tab">Photos <strong>(20)</strong></a></li>
				<li role="presentation"><a href="#auctionsMD" aria-controls="auctions" role="tab" data-toggle="tab">Auctions <strong>(3)</strong></a></li>
				<li role="presentation"><a href="#aboutMeMD" aria-controls="aboutMe" role="tab" data-toggle="tab">About me</a></li>
				<li role="presentation"><a href="#activityStreamMD" aria-controls="activityStream" role="tab" data-toggle="tab">Activity Stream</a></li>
				<li role="presentation"><a href="#camScheduleMD" aria-controls="camSchedule" role="tab" data-toggle="tab">Cam Schedule</a></li>
			</ul>

			<!-- Tab panes -->
			<div class="tab-content">
				<!-- Shop Items -->
				<div role="tabpanel" class="tab-pane active" id="shopItemsMD">
					<div class="row" style="margin:10px 0px">
						<div class="col-md-offset-6 col-md-6 text-right">
							<select name="categoriesAuctions" data-width="fit" data-title="Categories" class="selectpicker visible-md-inline-block visible-md-inline-block">
								<option>All</option>
							...
							<select name="sortAuctions" data-width="fit" data-title="Sort by" class="selectpicker visible-md-inline-block visible-md-inline-block">
								<option>All</option>
				...
				<!-- Photos -->
				<div role="tabpanel" class="tab-pane" id="photosMD">
					<div class="row-fluid img">
						<div class="col-md-3">
							<img src="http://placehold.it/240x200?text=Bra" class="img-responsive">
							<p class="descripcion">Descripción</p>
				...
				<!-- Auctions -->
				<div role="tabpanel" class="tab-pane" id="auctionsMD">
					<div class="row" style="margin:10px 0px">
						<div class="col-md-offset-6 col-md-6 text-right">
							<select name="categoriesAuctions" data-width="fit" data-title="Categories" class="selectpicker visible-md-inline-block visible-md-inline-block">
								<option>All</option>
				...
				<!-- About Me -->
				<div role="tabpanel" class="tab-pane" id="aboutMeMD">
					<h2>This is me</h2>
				...
				<!-- Activity Stream -->
				<div role="tabpanel" class="tab-pane" id="activityStreamMD">
					<div class="row" style="margin:10px 0px;">
						<div class="col-md-12 headActivityStream">
							<div class="row-fluid">
								<div class="col-md-3"><strong class="timeline">Timeline</strong></div>
								<div class="col-md-6">
									<p class="text-center">
								...
								<div class="col-md-offset-2 col-md-1 text-">
				...
				<!-- Cam Schedule -->
				<div role="tabpanel" class="tab-pane" id="camScheduleMD">...</div>
			</div>
		</div>
	</div>
</div>
